...
<html lang="zxx">
    <head>
        <!-- meta tag -->
        <meta charset="utf-8">
        <title>Register | Neuron - Machine Learning & AI Startups HTML5 Template</title>
            ...
            <div class="container">
                ...
                <div class="register-width">
                    <form class="register-form" id="register-form" method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>">
                        ...
                        <input class="custom-placeholder" type="text" name="username" required value="<?php echo $username; ?>">
                        ...
                        <div class="row">
                            <div class="col-md-6 <?php echo (!empty($password_err)) ? 'has-error' : ''; ?>">
                                ...
                                <input class="custom-placeholder" type="password" name="password" required value="<?php echo $password; ?>">
                                <span ><?php echo $password_err; ?></span>
                            </div>
                            <div class="col-md-6 <?php echo (!empty($confirm_password_err)) ? 'has-error' : ''; ?>">
                                <label id="psw-repeat">Confirm Password</label>
                                <input class="custom-placeholder" type="password" name="confirm_password" required value="<?php echo $confirm_password; ?>">
